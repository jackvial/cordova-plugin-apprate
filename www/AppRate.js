...
AppRate = (function () {
    ...
    switch (buttonIndex) {
      ...
      case 1:
        ...
        if (AppRate.preferences.showAskForFeedbackPrompt) {
          ...
          typeof base.appRatingNotReallyClicked === "function" ? base.appRatingNotReallyClicked() : function () { };
        }
        break;
      case 2:
        currentBtn = localeObj.yesButtonLabel;
        navigator.notification.confirm(localeObj.message, promptForStoreRatingWindowButtonClickHandler, localeObj.title, [localeObj.cancelButtonLabel, localeObj.rateButtonLabel])
        break;
    }
  ...
  AppRate.preferences = {
    ...
    showAskForFeedbackPrompt: false,
    callbacks: {
      onButtonClicked: null,
      onRateDialogShow: null,
      handleNegativeFeedback: null,
      appRatingNotReallyClicked: null,
      done: null
    },
    storeAppURL: {
      ios: null,
